...
if(!function_exists("send_mail")){
	function send_mail($type, $uid){
		...
		$variables = [
            ...
            "{website_name}" => get_option('website_title', 'AceSuites - Social Marketing Tool'),
		...
		try {
		    ...
		    //Recipients
		    $mail->setFrom(get_option('email_from', 'example@gmail.com'), get_option('email_name', 'AceSuites'));
		    $mail->addAddress( get_email($uid), get_full_name($uid));
		    $mail->addReplyTo(get_option('email_from', 'example@gmail.com'), get_option('email_name', 'AceSuites'));
