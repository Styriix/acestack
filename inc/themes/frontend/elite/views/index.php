                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="main-banner-content">
                                    ...
                                    <p>With AceSuites you can manage all your social media in a single panel easily and with maximum security!</p>
		...
		<section class="funfacts-area ptb-110 bg-fcfbfb">
			<div class="container">
                <div class="section-title">
					<h2>AceSuites in Numbers!</h2>
                    <p>Check out our numbers and make sure AceSuites is the best for you!</p>
                </div>
