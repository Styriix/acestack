                    ...
                    <div class="pricing-table <?php _e( $key%3 == 0 ?"br-left":"" )?> <?php _e( $row->popular==1?"popular":"" )?>">
                        ...
                        <div class="pricing-header pricing-amount">
                            <div class="annual_price">
                                <h2 class="price">$<?php _e( $row->price_annually )?><span class="fw-4 fs-18"><?php _e("/month")?></span></h2>
                            </div>
                            <div class="monthly_price">
                                <h2 class="price">$<?php _e( $row->price_monthly )?><span class="fw-4 fs-18"><?php _e("/month")?></span></h2>
                            </div>
